...
class ConfigReader(BaseSettings):
    ...
    CUSTOMER_SERVICE_BASE_URL:str
    RECOMMENDATION_SERVICE_BASE_URL:str
    
    RABBITMQ_URI:Optional[str] = ""
    APP_VERSION:Optional[str] = "1.0.0"
    APP_TITLE:Optional[str] = "catalog-service"
    APP_SUMMARY:Optional[str] = "This micro-service deals with catalog management endpoints"
